...
def p_expresion_binaria_realacional(t):
    ...
    if t[2] == '=='  : t[0] = ExpresionBinaria(t[1], t[3], OPERACION_RELACIONAL.IGUAL)
    elif t[2] == '!=': t[0] = ExpresionBinaria(t[1], t[3], OPERACION_RELACIONAL.DIFERENTE)
    elif t[2] == '>=': t[0] = ExpresionBinaria(t[1], t[3], OPERACION_RELACIONAL.MAYORIGUAL)
    elif t[2] == '<=': t[0] = ExpresionBinaria(t[1], t[3], OPERACION_RELACIONAL.MENORIGUAL)
    elif t[2] == '>': t[0] = ExpresionBinaria(t[1], t[3], OPERACION_RELACIONAL.MAYOR_QUE)
    elif t[2] == '<': t[0] = ExpresionBinaria(t[1], t[3], OPERACION_RELACIONAL.MENOR_QUE)
...
def p_expresion_decimal(t):
    ...
    t[0] = ExpresionEntero(t[1], TS.TIPO_DATO.FLOAT)
...
def p_expresion_cadena(t) :
    ...
    t[0] = ExpresionEntero(t[1], TS.TIPO_DATO.CADENA)

def p_expresion_caracter(t):
    'expresion_numerica : CARACTER'
    t[0] = ExpresionEntero(t[1], TS.TIPO_DATO.CARACTER)
